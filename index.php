              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown mr-4">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="views/pengurus.php">Struktur Organisasi</a>
                    <a class="dropdown-item" href="views/visi-misi.php">Visi misi</a>
                  </div>
                </li>
                <li class="nav-item mr-4">
                  <a class="nav-link" href="views/prestasi.php">Prestasi</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="views/artikel.php">Artikel</a>
                </li>
              </ul>
            </div>
          </div>
